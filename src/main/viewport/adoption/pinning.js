 ...
 * Captures the console cert on first connect (LAN first-use window documented in
 * the security review), persists it per `host:port`, and verifies via a leaf-as-CA
 ...
 * ds connection's checkServerIdentity fail against the :443 web-proxy cert (see
 * final-review.md finding I1). A repeat probe of the SAME host:port still reuses
