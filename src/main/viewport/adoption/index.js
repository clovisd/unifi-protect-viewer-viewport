 ...
 * untouched — see final-review.md finding C1.
 */
...
class AdoptionClient extends EventEmitter {
  ...
  async start(conn) {
    try {
      ...
      // fallback grace window or an app relaunch (I#1, Task 6 review; comment
      // corrected per whole-branch review finding on the "retryable" claim).
